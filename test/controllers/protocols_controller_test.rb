...
class ProtocolsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create protocol" do
    assert_difference('Protocol.count') do
      post protocols_url, params: { protocol: { age: @protocol.age, alert: @protocol.alert, asa: @protocol.asa, bsc: @protocol.bsc, patient_id: @protocol.patient_id, weight: @protocol.weight } }
    end
  ...
  test "should update protocol" do
    patch protocol_url(@protocol), params: { protocol: { age: @protocol.age, alert: @protocol.alert, asa: @protocol.asa, bsc: @protocol.bsc, patient_id: @protocol.patient_id, weight: @protocol.weight } }
