...
class ProceduresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create procedure" do
    assert_difference('Procedure.count') do
      post procedures_url, params: { procedure: { category_id: @procedure.category_id, category_id: @procedure.category_id, name: @procedure.name } }
    end
  ...
  test "should update procedure" do
    patch procedure_url(@procedure), params: { procedure: { category_id: @procedure.category_id, category_id: @procedure.category_id, name: @procedure.name } }
